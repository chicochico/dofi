...
function color_customize()
    ...
    hl(0, "LineNrActive", { ctermfg = 7, ctermbg = 0, bold = true })
    ...
    hl(0, "StatusLineDefault", { ctermfg = 7, ctermbg = 0 })
    hl(0, "StatusLineNC", { ctermfg = 8, ctermbg = 0 })
    hl(0, "StatusLineNoFocus", { ctermfg = 8, ctermbg = 0, nocombine = true })
    hl(0, "StatusLineGitHead", { ctermfg = 20, ctermbg = 0, bold = true })
    hl(0, "StatusLineFilePath", { ctermfg = 4, ctermbg = 0 })
