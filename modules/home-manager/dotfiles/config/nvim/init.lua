...
function base16()
    ...
    hl(0, "FoldColumn", { ctermfg = 6 })
    hl(0, "Folded", { ctermfg = 8 })
    ...
    -- Diff highlighting
    hl(0, "DiffAdd", { ctermfg = 2 })
    hl(0, "DiffAdded", { ctermfg = 2 })
    hl(0, "DiffChange", { ctermfg = 8 })
    hl(0, "DiffDelete", { ctermfg = 1 })
    hl(0, "DiffFile", { ctermfg = 1 })
    hl(0, "DiffLine", { ctermfg = 4 })
    hl(0, "DiffNewFile", { ctermfg = 2 })
    hl(0, "DiffRemoved", { ctermfg = 1 })
    hl(0, "DiffText", { bold = true, ctermfg = 4 })
    ...
    -- Custom
    hl(0, "Active", { ctermfg = 21 })
    hl(0, "CurSearch", { ctermfg = 0, ctermbg = 16 })
    hl(0, "HorizontalSplit", { ctermfg = 18 })
    hl(0, "Inactive", { ctermfg = 8 })
    hl(0, "LineNrAbove", { ctermfg = 8 })
    hl(0, "LineNrActive", { ctermfg = 21, bold = true })
    hl(0, "LineNrBelow", { ctermfg = 8 })
    hl(0, "LineNrDefault", { ctermfg = 8, bold = true })
    hl(0, "StatusLineNoFocus", { ctermfg = 8, nocombine = true })
    hl(0, "StatusLineSeparator", { ctermfg = 8 })
end
