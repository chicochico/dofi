...
function! airline#themes#base16_chico#refresh()
  ...
  let g:airline#themes#base16_chico#palette.normal
        \ = airline#themes#generate_color_map(s:N1, s:N2, s:N3, s:N4, s:N5, s:N6)
  let g:airline#themes#base16_chico#palette.normal_modified = {
  ...
  let g:airline#themes#base16_chico#palette.insert_modified
  ...
  let g:airline#themes#base16_chico#palette.replace_modified
        \ = copy(g:airline#themes#base16_chico#palette.normal_modified)
  ...
  let g:airline#themes#base16_chico#palette.inactive
        \ = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
  let g:airline#themes#base16_chico#palette.inactive_modified = {
        \ 'airline_c': [s:gui09, '', s:base09, '', ''],
        \ }
endfunction

call airline#themes#base16_chico#refresh()
